            ...
            <div class="grid">
                    ...
                    <Fieldset class="h-full">
                        ...
                        >
                            <template #after>
                                ...
                                >
                                    <img
                                        v-for="_ in Math.min(5, form.totalInhabitants || 0)"
                                        src="/images/Liczba osób mieszkających.jpg"
                                        alt=""
                                        height="40"
                                    />
                                    <i v-if="(form.totalInhabitants || 0) > 5" class="ph ph-plus" />
                                </div>
                            </template>
                        </CalculationHorizontalInput>
                    </Fieldset>
                ...
                <div class="col-12">
                    <Fieldset>
                        ...
                        <CalculationHorizontalInput
                            v-model="form.fh"
                            label="Wysokość kondygnacji [cm] (+30cm)"
                        ...
                        <!-- TODO: W wireframe było inaczej, ale jeden pod drugim jakoś nie pasuje. Dopytać się -->
                ...
                <div v-if="!form.hasBasement" class="col-12 debug">
                    <!---
                    ...
                    <Fieldset>
                        ...
                        <CalculationHorizontalInputSection label="Materiał podłogi" :col="12">
                    ...
                    <Fieldset class="mt-5">
                        ...
                        <CalculationHorizontalInputSection label="Materiał izolacyjny" :col="12">
                            <CalculationAutoComplete
                                v-model="form.gsbmM"
