...
export type CalculationForm = {
    ...
    isAtticHeated: boolean; // Czy poddasze jest ogrzewane?
    kwh: Nullable<number>; // Wysokość ściany kolankowej [m]
    asbmM: string | MaterialResource; // Materiał podstawowy poddasza
    asbmD: Nullable<number>; // Grubość materiału podstawowego poddasza [m]
    assmM: Nullable<number>; // Materiał dodatkowy poddasza
    assmD: Nullable<number>; // Grubość materiału dodatkowego poddasza [m]
    asimM: string | MaterialResource; // Materiał izolacji poddasza
    asimD: Nullable<number>; // Grubość materiału izolacji poddasza [m]

    roofInsulationType: Nullable<EnumOptionsResource>; // Co dzieje się na dachu?
