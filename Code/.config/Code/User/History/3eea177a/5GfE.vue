                    ...
                    <Fieldset>
                        <template #legend>
                            <div class="flex align-items-center pl-2">
                                <span class="font-bold">Ściany</span>
                            </div>
                        </template>
                        <CalculationHorizontalInputSection label="Materiał podstawowy ściany" :col="12">
                            ...
                            <CalculationInput
                                v-model="form.embD"
                                label="Grubość materiału podstawowego [cm]"
                                :col="4"
                        ...
                        <CalculationHorizontalInputSection label="Materiał dodatkowy ściany" :col="12">
                            ...
                            <CalculationInput
                                v-model="form.esmD"
                                label="Grubość materiału dodatkowego [cm]"
                                :col="4"
                        ...
                        <CalculationHorizontalInputSection label="Materiał izolacji ściany" :col="12">
                            ...
                            <CalculationInput
                                v-model="form.eimD"
                                label="Grubość materiału izolacji [cm]"
                                :col="4"
