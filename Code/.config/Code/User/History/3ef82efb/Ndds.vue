            ...
            <div class="grid">
                    ...
                    <Fieldset>
                        <template #legend>
                            <div class="flex align-items-center pl-2">
                                <span class="font-bold">Okna</span>
                            </div>
                        </template>
                        ...
                        <h3 for="input" class="font-medium text-900 text-4xl text-center mb-4">Powierzchnia okien</h3>

                        <div class="input-grid">
                            <div class="input-grid-center flex place-items-center">
                                <WallDimensionPreview class="mx-auto" :width="form.bw ?? 1" :height="form.bl ?? 1" />
                            </div>
                            <CalculationInput
                                class="input-grid-north w-24rem mx-auto my-auto"
                                v-model="form.aWN"
                            ...
                            />
                            <CalculationInput
                                class="input-grid-east w-24rem mx-auto my-auto"
                                v-model="form.aWE"
                            ...
                            />
                            <CalculationInput
                                class="input-grid-south w-24rem mx-auto my-auto"
                                v-model="form.aWS"
                            ...
                            />
                            <CalculationInput
                                class="input-grid-west w-24rem mx-auto my-auto"
                                v-model="form.aWW"
                ...
                <div class="col-12">
                    <Fieldset class="">
                        <template #legend>
                            <div class="flex align-items-center pl-2">
                                <span class="font-bold">Drzwi</span>
                            </div>
                        </template>
