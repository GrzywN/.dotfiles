    ...
    <component :is="parentComponent" v-model:form="form">
        <div class="card">
            <div class="grid">
                ...
                <div class="col-12">
                    <pre>
Czy piwnica jest ogrzewana?											checkbox

Materiał stropu nad piwnicą											dropdown					input			cm

Docieplenie stropu nad piwnicą											dropdown					input			cm


Materiał ścian piwnicy											dropdown					input			cm		tylko jeśli piwnica ogrzewana!

Docieplenie ścian piwnicy											dropdown					input			cm

Poziom poniżej gruntu											input			m
