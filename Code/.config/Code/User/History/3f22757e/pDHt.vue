                    ...
                    <Fieldset>
                        <template #legend>
                            <div class="flex align-items-center pl-2">
                                <span class="font-bold">Piwnica</span>
                            </div>
                        </template>
                        ...
                        <CalculationHorizontalInputSection label="Materiał stropu nad piwnicą" :col="12">
                            ...
                            <CalculationInput
                                v-model="form.bsbmD"
                                label="Grubość stropu nad piwnicą [cm]"
                                :col="3"
                        ...
                        <CalculationHorizontalInputSection label="Docieplenie stropu nad piwnicą" :col="12">
                            ...
                            <CalculationInput
                                v-model="form.bsimD"
                                label="Grubość docieplenia stropu [cm]"
                                :col="3"
                        ...
                        <CalculationHorizontalInputSection label="Materiał podłogi piwnicy" :col="12">
                            <CalculationAutoComplete
                                v-model="form.gsimM2"
                            ...
                            <CalculationInput
                                v-model="form.gsimD2"
                                label="Grubość podłogi piwnicy [cm]"
                                :col="3"
                        ...
                        <CalculationHorizontalInputSection label="Materiał izolacyjny podłogi piwnicy" :col="12">
                            <CalculationAutoComplete
                                v-model="form.gsbmM2"
                            ...
                            <CalculationInput
                                v-model="form.gsbmD2"
                                label="Grubość izolacyjny podłogi piwnicy [cm]"
                                :col="3"
                ...
                <div v-if="form.isBasementHeated" class="col-12">
                    <Fieldset>
                        ...
                        <CalculationHorizontalInputSection label="Materiał ścian piwnicy" :col="12">
                            ...
                            <CalculationInput
                                v-model="form.ebbmD"
                                label="Grubość ścian zewnętrznych piwnicy [cm]"
                                :col="3"
                        ...
                        <CalculationHorizontalInputSection label="Docieplenie ścian piwnicy" :col="12">
                            ...
                            <CalculationInput
                                v-model="form.ebimD"
                                label="Grubość docieplenia ścian zewnętrznych piwnicy [cm]"
                                :col="3"
                        ...
                        <CalculationHorizontalInputSection label="Poziom poniżej gruntu" :col="12">
                            ...
                            <CalculationInput
                                v-model="form.z"
                                label="Głębokość poniżej gruntu [m]"
                                :col="3"
