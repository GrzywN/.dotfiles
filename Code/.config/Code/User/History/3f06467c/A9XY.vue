...
const roofImageSrc = computed(() => {
    return `/images/${roofTypes.find((type) => String(type.value) === String(form.roofAreaFactor))?.image}`;
});
</script>
            ...
            <div class="grid">
                ...
                <div class="col-12">
                    <Fieldset>
                        ...
                        >
                            <template #after
                                ><img :src="roofImageSrc" alt="" />
                                {{
                                    `/images/${
                                        roofTypes.find((type) => String(type.value) === String(form.roofAreaFactor))
                                            ?.image
                                    }`
                                }}
                            </template>
