            ...
            <div class="grid">
                ...
                <div class="col-12">
                    <Fieldset>
                        ...
                        <CalculationHorizontalInputSection label="Wysokość ściany kolankowej" :col="12">
                            <CalculationInput
                                v-model="form.kwh"
                        ...
                        <CalculationHorizontalInputSection label="Materiał podstawowy poddasza" :col="12">
                        ...
                        <CalculationHorizontalInputSection label="Materiał dodatkowy poddasza" :col="12">
                            <CalculationAutoComplete
                                v-model="form.assmM"
                        ...
                        <CalculationHorizontalInputSection label="Materiał izolacji poddasza" :col="12">
                            <CalculationAutoComplete
                                v-model="form.asimM"
                ...
                <div class="col-12">
                    <Fieldset>
                        ...
                        <CalculationHorizontalInput
                            label="Co dzieje się na dachu?"
                            :error-message="form.errors.roofInsulationType"
                        >
                            <template #input>
                                <Dropdown
