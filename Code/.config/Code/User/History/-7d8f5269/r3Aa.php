...
class CalculatorFactorsRequest extends StepByStepRequest
{
    ...
    public function validateStepByStep(): void
    {
        ...
        $this->validateStep([
            ...
            'gsimM' => 'required_if:hasBasement,false|nullable|numeric',
            'gsimD' => 'required_if:hasBasement,false|nullable|numeric',

            'gsbmM' => 'required_if:hasBasement,false|nullable|numeric',
            'gsbmD' => 'required_if:hasBasement,false|nullable|numeric',
        ]);
