...
class CalculatorFactorsRequest extends StepByStepRequest
{
    ...
    public function validateStepByStep(): void
    {
        ...
        $this->validateStep([
            /* Ściany */
            'ebmM' => 'required|numeric', // Materiał podstawowy ściany
            'embD' => 'required|numeric', // Grubość materiału podstawowego [cm]

            'esmM' => 'nullable|numeric', // Materiał dodatkowy ściany
            'esmD' => 'required_with:esmM|nullable|numeric', // Grubość materiału dodatkowego [cm]

            'eimM' => 'nullable|numeric', // Materiał izolacji ściany
            'eimD' => 'required_with:eimM|nullable|numeric', // Grubość materiału izolacji [cm]

            /* Dodatkowe informacje */
            'hasAirVoid' => 'required|boolean', // Czy ściana ma pustkę powietrzną?
            'balL' => 'required|numeric', // Długość balkonów [cm]
        ]);
        ...
        $this->validateStep([
            /* Izolacja dachu */
            'isAtticHeated' => 'required|boolean',              // Czy poddasze jest ogrzewane?

            'kwh' => 'required|numeric',                        // Wysokość ściany kolankowej [m]

            'asbmM' => 'required|numeric|min:0.01',             // Materiał podstawowy poddasza
            'asbmD' => 'required|numeric',                      // Grubość materiału podstawowego poddasza [m]

            'assmM' => 'nullable|numeric',                      // Materiał dodatkowy poddasza
            'assmD' => 'required_with:assmM|nullable|numeric',  // Grubość materiału dodatkowego poddasza [m]

            'asimM' => 'nullable|numeric',                      // Materiał izolacji poddasza
            'asimD' => 'required_with:asimM|nullable|numeric',  // Grubość materiału izolacji poddasza [m]

            /* Co dzieje się na dachu */
            'roofInsulationType' => [                           // Co dzieje się na dachu?
                'required',
