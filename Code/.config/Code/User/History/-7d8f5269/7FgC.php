...
class CalculatorFactorsRequest extends StepByStepRequest
{
    ...
    public function validateStepByStep(): void
    {
        ...
        $this->validateStep([
            ...
            'fh' => 'required|numeric',                 // Wysokość kondygnacji [m] (+30cm)
            'eiTemp' => 'required|numeric',             // Oczekiwana temperatura wewnetrzna
            'substrateType' => [                        // Typ podłoża
                'required',
                new Enum(SubstrateType::class),
            ],
            // TODO: trzeba uwzględnić w obliczeniach typeOfVentilation
            // 'isMechanical' => 'required|boolean',       // Wentylacja mechaniczna
            ...
            // 'isBasementHeated' => 'required|boolean',

            // vvv - w przypadku gdy nie wybierzemy piwnice, to pola pod powierzchni podlogi bierzemy tutaj

            'gsimM' => 'required_if:isBasementHeated,false|nullable|numeric',
            'gsimD' => 'required_if:isBasementHeated,false|nullable|numeric',

            'gsbmM' => 'required_if:isBasementHeated,false|nullable|numeric',
            'gsbmD' => 'required_if:isBasementHeated,false|nullable|numeric',
        ]);
