    ...
    form.value
        .transform((data) => {
            ...
            return {
                ...
                typeOfVentilation: data.typeOfVentilation?.value,
                roofInsulationType: data.roofInsulationType?.value,
                fh: centimetersToMeters(data.fh), // Wysokość kondygnacji [cm] (+30cm)
                ...
                // Piwnica
                bsbmD: centimetersToMeters(data.bsbmD), // Grubość stropu nad piwnicą [cm]
                bsimD: centimetersToMeters(data.bsimD), // Grubość docieplenia stropu [cm]
                ebbmD: centimetersToMeters(data.ebbmD), // Grubość ścian zewnętrznych piwnicy [cm]
                ebimD: centimetersToMeters(data.ebimD), // Grubość docieplenia ścian zewnętrznych piwnicy [cm]

                gsimD2: centimetersToMeters(data.gsimD2), // Grubość podłogi piwnicy [cm]
                gsbmD2: centimetersToMeters(data.gsbmD2), // Grubość izolacyjny podłogi piwnicy [cm]
            };
        })
